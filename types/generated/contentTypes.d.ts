...
export interface ApiMremberMrember extends Struct.CollectionTypeSchema {
  collectionName: 'mrembers';
  info: {
    displayName: 'mrember';
    pluralName: 'mrembers';
    singularName: 'mrember';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    inviteCode: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mrember.mrember'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::mrember.mrember': ApiMremberMrember;
